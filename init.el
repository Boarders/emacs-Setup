...
(global-set-key (kbd "C-j") 'god-local-mode)
...
(custom-set-variables
 ...
 '(package-selected-packages
  (quote
   (proof-general god-mode psc-ide racket-mode hungry-delete solarized-theme multiple-cursors merlin tuareg use-package dante rust-mode idris-mode haskell-mode)))
